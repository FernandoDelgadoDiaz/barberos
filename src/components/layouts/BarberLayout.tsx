  ...
  return (
    <div style={{ minHeight: '100vh', background: '#080808' }}>
      <header style={{ background: '#080808', borderBottom: '1px solid #1c1c1c', padding: '14px 20px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          <span style={{ background: '#161616', border: '1px solid #2a2a2a', borderRadius: '100px', padding: '4px 12px', fontSize: '10px', color: '#555', letterSpacing: '1.5px', textTransform: 'uppercase' }}>barbero</span>
          <div style={{ width: '30px', height: '30px', borderRadius: '50%', background: 'linear-gradient(135deg, #B8FF47, #4a9900)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'Syne, sans-serif', fontWeight: 800, fontSize: '11px', color: '#080808' }}>{initials}</div>
